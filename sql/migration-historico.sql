-- APLICADA EM PRODUÇÃO. Este arquivo foi versionado em 15/08/2026, resgatado do
-- PR #4 (aberto em 05/04/2026 e nunca mergeado). A migration já havia sido
-- executada no banco por fora do repositório: a tabela capturas_historico
-- existe em produção com exatamente estas 17 colunas, na mesma ordem e com os
-- mesmos tipos — conferido coluna a coluna antes de versionar.
--
-- Mantido aqui por rastreabilidade: sem o arquivo, a estrutura em produção não
-- tinha correspondência no repositório.
