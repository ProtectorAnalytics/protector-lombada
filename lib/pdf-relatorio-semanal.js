...
async function gerarRelatorioSemanalPDF({ cliente, metricas: m }) {
  return new Promise((resolve, reject) => {
    try {
      ...
      if (m.fora_faixa > 0) {
        nota += ` ${N(m.fora_faixa)} leitura(s) acima de 250 km/h foram descartadas: esse é o teto `
          + 'de medição do equipamento, e valores acima dele indicam ruído do sensor, não velocidade real.';
      }
