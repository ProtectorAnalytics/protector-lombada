 ...
 */
async function gerarPDF({ cliente, captura, veiculo, fotoBuffer, historico }) {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fontSize(18).font('Helvetica-Bold').fillColor('#CC0000')
        .text('NOTIFICAÇÃO ORIENTATIVA', { align: 'center' });

      doc.moveDown(0.3);
      doc.fontSize(10).font('Helvetica').fillColor('#333333')
        .text('Transitar em velocidade superior à máxima permitida', { align: 'center' });
      ...
      doc.moveDown(0.2);
      doc.fontSize(9).font('Helvetica-Bold').fillColor('#FF6B00')
        .text('Lombada Educativa', { align: 'center' });
      ...
      doc.fontSize(8).font('Helvetica').fillColor('#888888')
        .text('Sistema de monitoramento | Protector Sistemas de Segurança Eletrônica', { align: 'center' });
